<%@ Page Title="Печать термо ценников" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CennicListTermo.aspx.cs" Inherits="Saalut.CennicListTermo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <article>
        <p>
            Проверьте принтер, данные отправлены не печать.<br />
