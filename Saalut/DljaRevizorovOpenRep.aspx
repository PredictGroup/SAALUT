<%@ Page Title="Для ревизоров. Отчет по продажам по группе в открытой смене" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DljaRevizorovOpenRep.aspx.cs" Inherits="Saalut.DljaRevizorovOpenRep" %>
